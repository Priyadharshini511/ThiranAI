...
// //   CodeChef: "https://raw.githubusercontent.com/github/explore/c432a21abaa4326f9e64194b3a0a7224b4069ace/topics/codechef/codechef.png",
// // };
...
// //     ],
// //     HackerRank: [
// //       { title: "Solve Me First", link: "https://www.hackerrank.com/challenges/solve-me-first/problem" },
// //       { title: "Simple Array Sum", link: "https://www.hackerrank.com/challenges/simple-array-sum/problem" },
// //     ],
// //     CodeChef: [
// //       { title: "Turbo Sort", link: "https://www.codechef.com/problems/TURBO" },
// //       { title: "Life, the Universe, and Everything", link: "https://www.codechef.com/problems/TEST" },
// //     ],
// //   },
// //   Medium: {
// //     LeetCode: [
...
// //     ],
// //     HackerRank: [
// //       { title: "Java String Reverse", link: "https://www.hackerrank.com/challenges/java-string-reverse/problem" },
// //     ],
// //     CodeChef: [
// //       { title: "Chef and Strings", link: "https://www.codechef.com/problems/CHEFSTR1" },
// //     ],
// //   },
// //   Hard: {
// //     LeetCode: [
...
// //     ],
// //     HackerRank: [
// //       { title: "Matrix Layer Rotation", link: "https://www.hackerrank.com/challenges/matrix-rotation-algo/problem" },
// //     ],
// //     CodeChef: [
// //       { title: "Ciel and Flowers", link: "https://www.codechef.com/problems/FLOWERS" },
// //     ],
// //   },
// // };
...
// // const PracticeCode = () => {
// //   return (
// //     <div className="min-h-screen bg-gradient-to-br from-[#f7faff] to-[#e1e8f0] px-4 py-10 sm:px-8 lg:px-20">
// //       <h1 className="text-4xl font-extrabold text-center bg-gradient-to-r from-[#4c669f] to-[#6A89A7] bg-clip-text text-transparent mb-12">
// //         Sharpen Your Coding Skills
// //       </h1>

// //       <div className="max-w-4xl mx-auto flex flex-col gap-16">
// //         {Object.entries(practiceData).map(([difficulty, platforms]) => (
// //           <div key={difficulty}>
// //             <h2 className="text-3xl font-semibold text-center text-[#384959] mb-6 tracking-wide">
// //               {difficulty} Level
// //             </h2>

// //             <div className="flex flex-col gap-4">
// //               {Object.entries(platforms).map(([platform, questions]) =>
// //                 questions.map((q, i) => (
// //                   <div
// //                     key={`${platform}-${i}`}
// //                     className="bg-white border-l-4 border-[#6A89A7] rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1 duration-200 flex items-center gap-5 px-5 py-4"
// //                   >
// //                     <img
...
// //                       <div className="text-sm font-semibold text-white bg-[#6A89A7] px-3 py-1 rounded-full inline-block">
// //                         {platform}
// //                       </div>
// //                       <a
// //                         href={q.link}
...
// //                         className="block mt-2 text-lg font-medium text-[#384959] hover:underline"
// //                       >
// //                         {q.title}
// //                       </a>
// //                     </div>
